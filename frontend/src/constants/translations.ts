...
export const translations = {
  de: {
    ...
    noBackendConfigured: 'Server nicht erreichbar – Suche momentan nicht möglich.',
    demoAlertNote: 'Demo-Alarm aktiv – echte Preisalarme benötigen Serververbindung.',
  ...
  en: {
    ...
    noBackendConfigured: 'Server not reachable – search is currently unavailable.',
    demoAlertNote: 'Demo alert active – real price alerts require a server connection.',
    navigation: 'Navigate',
