...
export const translations = {
  de: {
    ...
    tryAdjustingFilters: 'Keine Tankstellen gefunden. Ändere den Radius oder versuche einen anderen Ort.',
    tryAgain: 'Erneut versuchen',
    noStationsHint: 'Keine Tankstellen gefunden. Ändere den Radius oder versuche einen anderen Ort.',
    radiusExpanded: 'Radius automatisch erweitert',
    noStationsApiError: 'Verbindungsfehler – bitte erneut versuchen.',
    noBackendConfigured: 'Supabase nicht konfiguriert – Stationssuche nicht verfügbar.',
    demoAlertNote: 'Demo-Modus: Preisalarme werden lokal gespeichert.',
    ...
    backendNoConfig: 'Demo-Modus: Alarme werden lokal gespeichert, keine Server-Synchronisierung.',
  ...
  en: {
    ...
    tryAdjustingFilters: 'No stations found. Adjust the radius or try another area.',
    tryAgain: 'Try again',
    noStationsHint: 'No stations found. Adjust the radius or try another area.',
    radiusExpanded: 'Radius expanded automatically',
    noStationsApiError: 'Connection error – please try again.',
    noBackendConfigured: 'Supabase not configured – station search unavailable.',
    demoAlertNote: 'Demo mode: price alerts are saved locally only.',
    navigation: 'Navigate',
    ...
    backendNoConfig: 'Demo mode: alerts saved locally only, no server sync.',
